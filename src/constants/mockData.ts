...
function createStudent(
  ...
  return {
    ...
    lastName,
    gradeId:
      partial.gradeId ?? partial.grade.toLowerCase().replace(/\s+/g, "-"),
    sectionId:
      partial.sectionId ?? `${partial.grade}-${partial.section}`.toLowerCase(),
...
export const mockTeachers: Teacher[] = [
  {
    ...
    assignedSections: ["9A", "10B"],
    bioEn: "Senior Math specialist.",
    bioAm: "የሒሳብ መምህር።",
    totalAlerts: 2,
  ...
  },
  {
    ...
    employeeId: "FAC002",
    subjects: ["Science"],
    assignedSections: ["10A"],
    bioEn: "Science teacher.",
    bioAm: "የሳይንስ መምህርት።",
    totalAlerts: 0,
  ...
  },
  {
    ...
    employeeId: "FAC003",
    subjects: ["History"],
    assignedSections: ["11A"],
    bioEn: "History teacher.",
    bioAm: "የታሪክ መምህር።",
    totalAlerts: 5,
